...
public class Conversation_Location_Acy extends MapActivity implements
	...
	private int sucess=1;//判断定位是否成功0成功1 
    @Override
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.conversation_soso_map);
        ...
        linearLayout=(LinearLayout) findViewById(R.id.liner_titlebar_back_map);
    ...
    public boolean handleMessage(Message msg) {
        if (msg.what == RENDER_POI) {
            ...
            mMapView.getMap().addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.drawable.icon_my_location))
                    .position(latLng)
                    .draggable(true));
    ...
    public void onLocationChanged(final TencentLocation tencentLocation,
        ...
        if (TencentLocation.ERROR_OK == code) {
        	...
        	sucess=1;
        	  Toast.makeText(this, " 定位失败,无法获取您的当前位置！", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onClick(View v) {
		if (sucess == 1) {
			 Toast.makeText(this, " 定位失败,无法发送当前位置！", Toast.LENGTH_SHORT).show();
		} else {
			if (mMsg != null) {
				A_0_App.getInstance().getLastLocationCallback().onSuccess(mMsg);
				A_0_App.getInstance().setLastLocationCallback(null);
				finish();
    ...
    private class POISearchRunnable implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                TencentSearch tencentSearch = new TencentSearch(Conversation_Location_Acy.this);
        ...
        public void onChanged(ConnectionStatus connectionStatus) {
            ...
            switch (connectionStatus) {
                ...
                case DISCONNECTED:// 断开连接。
                    ...
                    //A_0_App.getInstance().showExitDialog(Conversation_Location_Acy.this,getResources().getString(R.string.token_timeout));
                    break;
                case CONNECTING:// 连接中。
                ...
                case KICKED_OFFLINE_BY_OTHER_CLIENT:// 用户账户在其他设备登录，本机会被踢掉线
                    ...
                    class LooperThread extends Thread {
                        public void run() {
                            Looper.prepare();
                            A_0_App.getInstance().showExitDialog(Conversation_Location_Acy.this, AppStrStatic.kicked_offline());
                            Looper.loop();
                        }
                    }
