...
import com.yuanding.schoolpass.service.Api.InterContactListStu;
...
/**
 * @author Jiaohaili 
 * @version 创建时间：2016年1月5日 下午4:27:17
 * 班级页面
 */
public class B_Mess_Forward_Select_ClassMate  extends A_0_CpkBaseTitle_Navi implements SideBar.OnTouchingLetterChangedListener, TextWatcher {
	...
	private Handler handler=new Handler()
	{
		public void handleMessage(android.os.Message msg) {
			A_0_App.select_classmate=false;
		};
	};
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    setView(R.layout.activity_contact_colleague);
        ...
        options = A_0_App.getInstance().getOptions(R.drawable.i_default_por_120,
                ...
                R.drawable.i_default_por_120);
        //bitmapUtils=A_0_App.getBitmapUtils(B_Mess_Forward_Select_ClassMate.this, R.drawable.ic_defalut_person_center, R.drawable.ic_defalut_person_center);
        ...
        mListView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
                    ...
                    public void onPullDownToRefresh(PullToRefreshBase<ListView> refreshView) {
                        String label = DateUtils.formatDateTime(B_Mess_Forward_Select_ClassMate.this,
      ...
      //**************************新增到这**********************
        ...
        if (A_0_App.USER_STATUS.equals("5")||A_0_App.USER_STATUS.equals("0") ) {
            ...
            mAdapter = new SchoolFriendMemberListAdapter(B_Mess_Forward_Select_ClassMate.this, sortDataList);
            mListView.setAdapter(mAdapter);
            
            sortDataList.clear();
            sortDataList.addAll(A_0_App.getInstance().getmContactClasss());
        ...
        if (RongIM.getInstance().getCurrentConnectionStatus().equals(ConnectionStatus.CONNECTED)) {
            ...
            reconnect(A_0_App.USER_QUTOKEN, B_Mess_Forward_Select_ClassMate.this);
        }
	}
	...
	private void initData() {
		...
		A_0_App.getApi().getContactStuList(B_Mess_Forward_Select_ClassMate.this,A_0_App.USER_TOKEN,new InterContactListStu() {
					@Override
					public void onSuccess(List<Cpk_Persion_Contact> mList) {
						...
						if (mList != null && mList.size() > 0) {
							...
							A_0_App.getInstance().getmContactClasss().addAll(mList);
                    ...
                    public void onFailure(String msg) {
                        if (isFinishing())
                            return;
                        PubMehods.showToastStr(B_Mess_Forward_Select_ClassMate.this,msg);
	...
	public class SchoolFriendMemberListAdapter extends BaseAdapter implements
		...
		public View getView(int position, View convertView, ViewGroup parent) {
                    ...
                    public void onClick(View v) {
                    	  if (A_0_App.getInstance().getNetWorkManager().isNetWorkConnected()) {
                              if(!PubMehods.isFastClick(AppStrStatic.WORD_COMMENT_MIN_LIMIT)||!temp_uid.equals(dto.getUniqid())){
                                  ...
                                  PubMehods.showToastStr(B_Mess_Forward_Select_ClassMate.this,"您的操作过于频繁！");
                              }
                          } else {
                              PubMehods.showToastStr(B_Mess_Forward_Select_ClassMate.this,R.string.error_title_net_error);
                          }
                    }
                });
			...
			if(A_0_App.isShowAnimation==true){
			 if(position>A_0_App.forward_class_curPosi||A_0_App.select_classmate)
			 {
				A_0_App.forward_class_curPosi=position;
	...
	private void showForwardDialog(View v)
	{
        ...
        final Dialog upDateDialog = new Dialog(B_Mess_Forward_Select_ClassMate.this,
        ...
        summit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (RongIM.getInstance().getCurrentConnectionStatus().equals(ConnectionStatus.CONNECTED)) {
                    ...
                    reconnectData(A_0_App.USER_QUTOKEN, B_Mess_Forward_Select_ClassMate.this,upDateDialog,requestType,dd,title, content, image_url, type, 
                            noticeId, "", "", "", "", "", acy_type, course_user_uniqid);
                }
            }
    ...
    private void getServiceTimeToShare(final Dialog upDateDialog,String requestType,final Cpk_Persion_Contact dd,final String titleStr, final String share_content, final String imgUrl, final String type,
            final String noticeId,final String notice_sendUserName, String share_time,
            final String unReadCount, final String message_level, final String placeImg,final String acy_type, final String course_user_uniqid) {
        A_0_App.getInstance().showProgreDialog(B_Mess_Forward_Select_ClassMate.this, "", true);
        A_0_App.getApi().getServiceTime(B_Mess_Forward_Select_ClassMate.this, A_0_App.USER_TOKEN,requestType,
                        ...
                        if (RongIM.getInstance() != null && cu != null) {
                            ...
                            try {
                                RongIM.getInstance().getRongIMClient()
                                        .sendMessage(Conversation.ConversationType.PRIVATE,dd.getUniqid(), cu, null,
                                                null, new SendMessageCallback() {

                                                    @Override
                                                    public void onSuccess(Integer arg0) {
                                                        A_0_App.getInstance().CancelProgreDialog(B_Mess_Forward_Select_ClassMate.this);
                                                        upDateDialog.dismiss();
                                                        PubMehods.showToastStr(B_Mess_Forward_Select_ClassMate.this,"转发成功");
                                                    }

                                                    @Override
                                                    public void onError(Integer arg0,ErrorCode arg1) {
                                                        A_0_App.getInstance().CancelProgreDialog(B_Mess_Forward_Select_ClassMate.this);
                                                        PubMehods.showToastStr(B_Mess_Forward_Select_ClassMate.this,"服务器开了小差,请重试！");
                                                        reconnect(A_0_App.USER_QUTOKEN, B_Mess_Forward_Select_ClassMate.this);
                                                    }
                                                });
                            } catch (Exception e) {
                                A_0_App.getInstance().CancelProgreDialog(B_Mess_Forward_Select_ClassMate.this);
                                PubMehods.showToastStr(B_Mess_Forward_Select_ClassMate.this, "转发失败，请重试");
                              }
                           }
                    }
                }, new Inter_Call_Back() {
        ...
        public void onChanged(ConnectionStatus connectionStatus) {
            ...
            switch (connectionStatus) {
                ...
                case DISCONNECTED:// 断开连接。
                    ...
                    //A_0_App.getInstance().showExitDialog(B_Mess_Forward_Select_ClassMate.this,getResources().getString(R.string.token_timeout));
                    break;
                case CONNECTING:// 连接中。
                ...
                case KICKED_OFFLINE_BY_OTHER_CLIENT:// 用户账户在其他设备登录，本机会被踢掉线
                    ...
                    class LooperThread extends Thread {
                        public void run() {
                            Looper.prepare();
                            A_0_App.getInstance().showExitDialog(B_Mess_Forward_Select_ClassMate.this,AppStrStatic.kicked_offline());
                            Looper.loop();
                        }
                    }
