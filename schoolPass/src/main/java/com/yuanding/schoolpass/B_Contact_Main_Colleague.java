 ...
 * 班级页面
 */
public class B_Contact_Main_Colleague  extends Fragment implements SideBar.OnTouchingLetterChangedListener, TextWatcher {
	...
	private Handler handler=new Handler()
	{
		public void handleMessage(android.os.Message msg) {
			A_0_App.colleague_flag=false;
		};
	};
	public B_Contact_Main_Colleague() {
		super();
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		viewone = inflater.inflate(R.layout.activity_contact_colleague, container, false);
		...
		options = A_0_App.getInstance().getOptions(R.drawable.ic_defalut_person_center,
				...
				R.drawable.ic_defalut_person_center);
		//bitmapUtils=A_0_App.getBitmapUtils(getContext().getApplicationContext(), R.drawable.ic_defalut_person_center, R.drawable.ic_defalut_person_center);
    ...
    private void readCache() {
        maACache=ACache.get(getContext().getApplicationContext());
        jsonObject=maACache.getAsJSONObject(AppStrStatic.cache_key_colleague+A_0_App.USER_UNIQID);
	...
	private void initData() {
		...
		A_0_App.getApi().getContactStuList(getContext().getApplicationContext(),A_0_App.USER_TOKEN,new InterContactListStu() {
					@Override
	...
	private List<Cpk_Persion_Contact> getList(JSONObject jsonObject) {
		// TODO Auto-generated method stub
			...
			if (state == 1) {
				mlistContact=JSON.parseArray(jsonObject.optJSONArray("clist")+"", Cpk_Persion_Contact.class);
			}
			return mlistContact;
	...
	public class SchoolFriendMemberListAdapter extends BaseAdapter implements
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
				...
				if(dto.getIs_invite()==1){					
					...
					holder.btn_invative.setOnClickListener(new OnClickListener() {							
						...
						public void onClick(final View arg0) {							
							...
							final GeneralDialog upDateDialog = new GeneralDialog(B_Contact_Main_Colleague.this.getContext(), R.style.Theme_GeneralDialog);
	        ...
	        if(position>A_0_App.colleague_curPosi||A_0_App.colleague_flag)
			 {
				...
				A_0_App.colleague_curPosi=position;
