...
/**
 * @author Jiaohaili 
 * @version 创建时间：2015年11月12日 下午3:18:18 招领————招领————招领
 */
public class B_Side_Found_Acy extends Fragment {
	...
	private void readCache() {
		...
		jsonObject = maACache.getAsJSONObject(AppStrStatic.cache_key_side_found_acy+A_0_App.USER_UNIQID);
	...
	private void getLectureList(int page_no, final boolean pullRefresh) {
		A_0_App.getApi().getLostList(getActivity(), "1", A_0_App.USER_TOKEN,
	...
	public class Mydapter extends BaseAdapter {
		...
		public View getView(final int posi, View converView, ViewGroup arg2) {
			...
			if(A_0_App.isShowAnimation==true){
			 if (posi > A_0_App.side_found_acy_curPosi) {
				A_0_App.side_found_acy_curPosi = posi;
...
//			                        (int) (4 * density), (int) (4 * density));
	...
	void delete(final String lost_id, final int posi) {
      ...
      if(getActivity() == null || getActivity().isFinishing())
          return;
      A_0_App.getInstance().showProgreDialog(getActivity(),"删除中，请稍候", true);
