...
public class SideBar extends View {
	...
	public SideBar(Context context, AttributeSet attrs) {
		...
		IntentFilter intentFilter = new IntentFilter("sidebar");
	...
	public class FinishReceiver extends BroadcastReceiver {@SuppressWarnings("deprecation")
	@Override
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int i = 0; i < b.length; i++) {
			...
			int sideBar=A_0_App.getInstance().setSideBar(9);
			paint.setTextSize(sideBar);
			// 选中的状态
			if (i == choose) {
