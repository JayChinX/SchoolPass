...
//		addView(mArrowImageView);
		...
		switch (mode) {
			case PULL_FROM_END:
				inAnimResId = R.anim.animal_slide_in_from_bottom_fullscreen_normal;
				outAnimResId = R.anim.animal_slide_out_to_bottom_fullscreen_normal;
			...
			case PULL_FROM_START:
				inAnimResId = R.anim.animal_slide_in_from_top_fullscreen_normal;
				outAnimResId = R.anim.animal_slide_out_to_top_fullscreen_normal;
