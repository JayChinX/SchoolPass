...
import com.yuanding.schoolpass.service.Api.InterNoticeListWaitSure;
...
//											Toast.makeText(B_Mess_Notice_List_WaitSure.this, "发送确认收到回执，"+mCourseList.get(mPosi).getTitle()+","+mCourseList.get(mPosi).getMessage_id(), Toast.LENGTH_SHORT).show();
...
//					}
					...
					holder.ll_notice.setOnClickListener(new OnClickListener() {
						...
						isHasUpdata = true;
						click_posi = mPosi;
						Intent intent = new Intent(B_Mess_Notice_List_WaitSure.this,B_Mess_Notice_Detail.class);
