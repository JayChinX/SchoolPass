...
public class B_Account_SystemNotice_Info extends Fragment {
...
//    protected BitmapUtils bitmapUtils;
    ...
    private String type = "2";   // 1 活动 2 校园资讯
...
//					holder.tx_replaymy_content.setMovementMethod(LinkMovementMethod.getInstance());
				...
				//原文类型
				holder.tx_original_type.setText("资讯: ");
				...
				converView.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						...
						Intent intent = new Intent(getActivity(),B_Side_Info_1_Detail_Acy.class);
						intent.putExtra("acy_type", 2);// 正常列表进入
						intent.putExtra("info_id", mCourseList.get(posi).getMessage_id()+"");
